...
<template>
  ...
  <div id="typefile_container" class="slide">
      ...
      <div class="column is-half" style="padding: 2em;">
        <form action="#" class="form ">
          ...
          <div class="field">
            ...
            <p class="control">
              <input name="name" class="input" type="text" placeholder="Del tipo de archivo">
            </p>
          ...
          <div class="field">
            ...
            <p class="control">
              <input name="description" class="input" type="text" placeholder="Descripción">
            </p>
      ...
      <div class="viewer column is-half">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <card-media :name="name" :body="body"></card-media>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        title_component: "Opciones de tipos de archivos",
        name: 'TypeFile_1',
        body: 'lashdjfhaskdfhk'
      }
    }
  }
</script>
